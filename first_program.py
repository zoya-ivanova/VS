...
# В задаче спрашивается: можно ли из длин строк построить арифметическую прогрессию (заметьте не обязательно она должна быть по порядку), 
# т.е. правильно и 135 и 153. A) если разница между длин строк a и b равна разнице b и c, то "ДА". B) 
# если разница между длин строк a и c равна разнице c и b, то "ДА". C) если разница между длин строк b и a равна разнице a и c, то "ДА".
